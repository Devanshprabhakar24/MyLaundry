...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-laundry-light-blue to-white flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-laundry-gray">
            Sign in to your account to manage your laundry orders
          </p>
        </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="password" className="flex items-center gap-2">
                  <Lock className="h-4 w-4 text-laundry-blue" />
                  Password
                </Label>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <Label
                    htmlFor="remember"
                    className="text-sm text-laundry-gray cursor-pointer"
                  >
                    Remember me
                  </Label>
                </div>
                <Link
                  to="/forgot-password"
                  className="text-sm text-laundry-blue hover:underline"
                >
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="my-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-laundry-gray">Or continue with</span>
                </div>
              </div>
            </div>
            ...
            <div className="text-center mt-6">
              <p className="text-sm text-laundry-gray">
                ...
                <Link to="/signup" className="text-laundry-blue hover:underline font-medium">
                  Create account
                </Link>
              </p>
            </div>
